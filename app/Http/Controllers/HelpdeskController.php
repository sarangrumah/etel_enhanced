...
class HelpdeskController extends Controller
{
    public function index()
    {
        ...
        return view('helpdesk.index', compact(['hld','vwhld_open', 'vwhld_wia', 'vwhld_done',
    ...
    public function save(Request $request)
    {
        ...
        // dd($filename1);
        $filepath = "storage/helpdesk/".$file1->getClientOriginalName();
        ...
        return redirect('/daftarlayanan')->with('Berhasil', 'Bantuan Layanan telah berhasil kami terima');
    }
