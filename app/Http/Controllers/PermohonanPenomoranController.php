...
class PermohonanPenomoranController extends Controller
{
    ...
    public function dashboard_penetapan()
    {
        ...
        $dashboard_penetapan = 1;
        $utilizin = new UtilPerizinan();
        $date_reformat = new DateHelper();
        $izin = $utilizin->getIzin("PENOMORAN_PENETAPAN");
        $izin_tetap = $utilizin->getIzin("TETAP_NOMOR");
        $izin_cabut = $utilizin->getIzin("CABUT_NOMOR");
        $done = count($utilizin->getIzin("TETAP_NOMOR"));
        $proses = NULL;
        $rejected = count($utilizin->getIzin("CABUT_NOMOR"));
        // dd($izin_tetap,$izin_cabut);
        // return view('layouts.frontend.penomoran.penomoran-baru', compact('permohonanizin'));
        return view('layouts.frontend.penomoran.dashboard_penomoran', compact('date_reformat', 'izin', 'done', 'proses', 'rejected','dashboard_penetapan'));
    }
