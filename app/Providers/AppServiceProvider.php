...
use App\View\Components\jaringan\roll_out_plan_jartaplok_cs;
...
use App\View\Components\daftar_perangkat_mtd;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        Blade::component('daftar_perangkat_mtd', daftar_perangkat_mtd::class);
        ...
        Blade::component('roll_out_plan_jartaplok_cs', roll_out_plan_jartaplok_cs::class);
