...
<p style="text-left">Permohonan Saudara dengan detail di bawah ini sudah selesai diproses.</p>
...
<table>
    ...
    <tr>
        ...
        <td>: <a href="{{ url('/ulo/permohonan') }}">{{ url('/ulo/permohonan') }}</a></td>

    </tr>
</table>

@if ($email_data['izin']['kd_izin']=='059000040066')
<p> Silakan
    melakukan pengajuan Izin Prinsip ulang. Terima Kasih</p>
@else 
<p> Silakan
    melakukan proses Uji Laik Operasi dan pastikan Izin Prinsip masih berlaku. Terima Kasih</p>
@endif
