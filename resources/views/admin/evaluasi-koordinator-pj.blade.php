...
<p style="text-left">Permohonan Saudara dengan detail di bawah ini sedang dalam proses evaluasi oleh ketua tim</p>
...
<table>
    ...
    {{-- z@if ($email_data['tipe_ulo'] !== '' || $email_data['tipe_ulo'] !== '-')
        <tr>
