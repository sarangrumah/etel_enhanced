...
{{-- <p style="font-size: 14px; line-height: 170%;"><span
        style="font-size: 16px; font-weight:bold; line-height: 27.2px;">{{ $email_data['nama'] }}</span></p> --}}
<p style="text-left"> Anda mendapat disposisi evaluasi persyaratan dengan detail permohonan sebagai berikut:</p>
...
<p> Mohon untuk segera ditindaklanjuti.
    Terima Kasih</p>
