                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <h1 class="v-font-size"
                                                                style="margin: 0px; line-height: 160%; text-align: center; word-wrap: break-word; font-weight: normal; font-family: 'Montserrat',sans-serif; font-size: 24px;">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div
                                                                style="color: #444444; line-height: 170%; text-align: left; word-wrap: break-word;">
                                                                <p style="font-size: 14px; line-height: 170%;"><span
                                                                        style="font-size: 16px; line-height: 27.2px;">Yth.
                                                                        {{ $email_data['nama'] }} </span></p>
                                                                {{-- <p style="font-size: 14px; line-height: 170%;"><span style="font-size: 16px; line-height: 27.2px;">Yth. {{ $email_data['departemen'] }}
                                                                </span></p>
                                                                <p style="font-size: 14px; line-height: 170%;"><span
                                                                        style="font-size: 16px; font-weight:bold; line-height: 27.2px;">{{ $email_data['nama'] }}</span>
                                                                </p> --}}
                                                                <br />
                                                                <p>
                                                                    Permohonan Saudara dengan detail di bawah ini sedang
                                                                    dalam proses evaluasi oleh Subkoordinator
                                                                </p>

                                                                <p>
                                                                    No. Permohonan :
                                                                    {{ isset($email_data['izin']['no_izin']) ? $email_data['izin']['no_izin'] :'-' }}<br />
                                                                    Tanggal Permohonan :
                                                                    {{ isset($email_data['izin']['tgl_izin']) ? $email_data['izin']['tgl_izin'] :'-' }}<br />
                                                                    {{-- Nama Perusahaan : {{ isset($email_data['izin']['nama_perseroan']) ? $email_data['izin']['nama_perseroan'] :'-' }}<br />
                                                                    --}}
                                                                    Nama Perusahaan : PT INDOSAT<br />
                                                                    Nomor Izin Berusaha (NIB) :
                                                                    {{ isset($email_data['izin']['nib']) ? $email_data['izin']['nib'] :'-' }}<br />
                                                                    Jenis Layanan :
                                                                    {{ isset($email_data['izin']['jenis_layanan']) ? $email_data['izin']['jenis_layanan'] :'-' }}<br />
                                                                    KBLI :
                                                                    {{ isset($email_data['izin']['full_kbli']) ? $email_data['izin']['full_kbli'] :'-' }}<br />
                                                                    URL : <a
                                                                        href="{{url('/admin/login')}}">{{url('/admin/login')}}</a><br />
                                                                </p>
                                                                <br />
                                                                <p>
                                                                    Mohon untuk menunggu proses ini selesai. Terima
                                                                    Kasih
                                                                </p>
                                                            </div>
                                                        ...
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-size: 18px; line-height: 25.2px;"><strong>Diskominfo</strong></span>
                                                                </p>
                                                            </div>
