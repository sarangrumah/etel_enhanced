...
<![endif]-->
  ...
  <title></title>
    ...
    <style type="text/css">
      table, td { color: #000000; } a { color: #cca250; text-decoration: none; } @media (max-width: 480px) { #u_content_image_4 .v-src-width { width: auto !important; } #u_content_image_4 .v-src-max-width { max-width: 57% !important; } #u_content_heading_3 .v-container-padding-padding { padding: 10px 20px !important; } #u_content_heading_3 .v-font-size { font-size: 28px !important; } #u_content_text_3 .v-container-padding-padding { padding: 10px 22px 26px !important; } #u_content_heading_2 .v-container-padding-padding { padding: 22px 22px 10px !important; } #u_content_heading_2 .v-font-size { font-size: 24px !important; } }
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr>
    <td style="padding-right: 0px;padding-left: 0px;" align="center">
      ...
      <img align="center" border="0" src="images/image-5.png" alt="Logo" title="Logo" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 47%;max-width: 272.6px;" width="272.6" class="v-src-width v-src-max-width"/>
...
<table id="u_content_heading_3" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <h1 class="v-font-size" style="margin: 0px; line-height: 160%; text-align: center; word-wrap: break-word; font-weight: normal; font-family: 'Montserrat',sans-serif; font-size: 24px;">
    <!-- <strong>Izin telah dilakukan Disposisi</strong> -->
  </h1>
    ...
    <tr>
      <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px 60px 50px;font-family:'Montserrat',sans-serif;" align="left">
        ...
        <div style="color: #444444; line-height: 170%; text-align: left; word-wrap: break-word;">
          <p style="font-size: 14px; line-height: 170%;"><span style="font-size: 16px; line-height: 27.2px;">Yth. {{ $email_data['nama'] }} </span></p>
          {{-- <p style="font-size: 14px; line-height: 170%;"><span style="font-size: 16px; line-height: 27.2px;">Yth. {{ $email_data['departemen'] }} </span></p> --}}
          {{-- <p style="font-size: 14px; line-height: 170%;"><span style="font-size: 16px; font-weight:bold; line-height: 27.2px;">{{ $email_data['nama'] }}</span></p> --}}
          <br/>
          <p>
            Permohonan Saudara dengan detail di bawah ini sedang dalam proses evaluasi oleh Subkoordinator
          </p>

          <p>
            No. Permohonan : {{ isset($email_data['izin']['no_izin']) ? $email_data['izin']['no_izin'] :'-' }}<br/>
            Tanggal Permohonan : {{ isset($email_data['izin']['tgl_izin']) ? $email_data['izin']['tgl_izin'] :'-' }}<br/>
            {{-- Nama Perusahaan : {{ isset($email_data['izin']['nama_perseroan']) ? $email_data['izin']['nama_perseroan'] :'-' }}<br/> --}}
            Nama Perusahaan : PT INDOSAT<br/>
            Nomor Izin Berusaha (NIB) : {{ isset($email_data['izin']['nib']) ? $email_data['izin']['nib'] :'-' }}<br/>
            Jenis Layanan : {{ isset($email_data['izin']['jenis_layanan']) ? $email_data['izin']['jenis_layanan'] :'-' }}<br/>
            KBLI : {{ isset($email_data['izin']['full_kbli']) ? $email_data['izin']['full_kbli'] :'-' }}<br/>
            URL : <a href="{{url('/admin/login')}}">{{url('/admin/login')}}</a><br/>

          </p>
          <br/>
          <p>
            Mohon untuk menunggu proses ini selesai. Terima Kasih
          </p>
        </div>
  ...
  <tbody>
    <tr>
      <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:40px 55px 10px;font-family:'Montserrat',sans-serif;" align="left">
        ...
        <p>
          Kontak Kami:<br/>
          DITJEN PPI KEMENTERIAN KOMUNIKASI DAN INFORMATIKA<br/>
          Jl. Medan Merdeka Barat No. 9, Jakarta Pusat, 10110<br/>
          Call Center: 159<br/>
          Pelayanan Terpadu Satu Pintu<br/>
          Email : helpdesk@pelayananprimaditjenppi.go.id<br/>
        </p>
...
<table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 18px; line-height: 25.2px;"><strong>Diskominfo</strong></span></p>
  </div>
...
<table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="color: #b0b1b4; line-height: 180%; text-align: center; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 180%;">&copy; <?php echo date('Y') ?> All Rights Reserved</p>
  </div>
