                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            @if ($help_open->status == 'Closed')
                                                <a href="/updatelayanan/{{ $help_open->id }}" class="dropdown-item"><i
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            @if ($help_done->status == 'Closed')
                                                <a href="/updatelayanan/{{ $help_done->id }}" class="dropdown-item"><i
                                                        class="icon-search4"></i>
                                                    Lihat
                                                    Detail</a>
                                            @else
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            @if ($help_cancelled->status == 'Closed')
                                                <a href="/updatelayanan/{{ $help_cancelled->id }}"
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            @if ($help_wia->status == 'Closed')
                                                <a href="/updatelayanan/{{ $help_wia->id }}" class="dropdown-item"><i
                                                        class="icon-search4"></i>
                                                    Lihat
                                                    Detail</a>
                                            @else
