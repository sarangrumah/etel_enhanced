	...
	<form method="post" id="formEvaluasi"
		...
		<div class="form-group">
								...
								<div class="form-group row">
									...
									<div class="col-lg-8" id="PilihKodeWilayah">
										<table class="text-center table table-custom table-sm">
											<thead>
												<tr>
													<th style="width: 25%; border-top: none;background: #fafafa;text-align: center;">
														Wilayah</th>
													<th style="width: 15%; border-top: none;background: #fafafa;text-align: center;">
														Kode
														Wilayah</th>
													<th style="width: 15%; border-top: none;background: #fafafa;text-align: center;">
														Blok Nomor
			...
			<div class="form-group text-right">
				...
				<button type="button" onclick="return validateForm();" class="btn btn-indigo">Kirim
					Evaluasi <i class="icon-paperplane ml-2"></i></button>
			</div>
		</div>
