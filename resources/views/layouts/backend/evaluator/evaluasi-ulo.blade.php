		...
		<form method="post" id="hasil_evaluasi"
			...
			<div class="card-body">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" name="TanggalSuratPerintahTugas" id="TanggalSuratPerintahTugas"
				...
				<div class="form-group text-right">
					@if ($ulo['status_hasil_evaluasi'] == 1)
						<button type="submit" class="btn btn-warning">Sunting <i class="icon-paperplane ml-2"></i></button>
					@else
						<button type="submit" class="btn btn-indigo">Simpan <i class="icon-paperplane ml-2"></i></button>
					@endif
				</div>
	...
	<div class="modal" id="submitModal_syarat" tabindex="-1" role="dialog">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-secondary notif-button" data-dismiss="modal">Batal</button>
					<button type="button" onclick="submitdisposisi_syarat();return false;"
						class="btn btn-primary notif-button">Kirim</button>
					<div class="spinner-border loading text-primary" role="status" hidden>
						<span class="sr-only">Loading...</span>
					</div>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button type="button" onclick="submitdisposisiTolak();return false;" class="btn btn-primary">Kirim</button>
					<div class="spinner-border loading text-primary" role="status" hidden>
						<span class="sr-only">Loading...</span>
					</div>
				</div>
