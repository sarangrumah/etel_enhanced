			...
			<div class="card-body">
				<form method="post" id="formDisposisi" action="{{ route('admin.koordinator.disposisipost', $id) }}">
					...
					<div class="form-group row">
						<div class="col-lg-12">
							<div class="row">
								<label class="col-lg-2 col-form-label">Nama Evaluator Sebelumnya </label>
								<div class="col-lg">
									<label class="col-lg col-form-label">: {{ $izin['evaluator_name'] }}</label>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="col-lg-12">
							<fieldset>
								<div class="form-group row">
									...
									<div class="col-lg">
										<select name="id_user_disposisi" data-placeholder="Silakan Pilih" class="form-control form-control-select2"
											required>
