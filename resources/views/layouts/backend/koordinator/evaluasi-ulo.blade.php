...
@elseif($ulo['status_laik'] == '2')
	...
	@endif
			...
			<div class="text-right">
				...
				{{-- <button type="submit" onclick="return false;" data-toggle="modal" data-target="#penolakanModal"
				class="btn btn-danger">Tolak Permohonan <i class="icon-cross2 ml-2"></i></button> --}}
