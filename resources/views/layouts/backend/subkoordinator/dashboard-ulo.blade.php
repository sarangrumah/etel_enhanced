...
@section('content')
	...
	<div class="row">
		<div class="col-lg">
			...
			<div class="card bg-primary text-white">
				<div class="card-body">
					<div class="d-flex">
						<h3 class="font-weight-semibold mb-0">{{ $countevaluasiulo }}</h3>
	...
	<div>
		...
		<div class="card">
			...
			<div class="card-body">
				<table class="table text-wrap datatable-button-init-basic" id="table">
					<thead>
						<tr>
							<th>Permohonan</th>
								...
								<tr>
									<td>
										<div class="d-flex align-items-center">
											<div>
												<a href="{{ route('admin.subkoordinator.evaluasi-ulo', [$ulos['id_izin'], $ulos['id']]) }}"
									...
									<td class="text-center"><span class="badge badge-success-100 text-success">{{ $ulos['name_status_bo'] }}</span>
									</td>
									<td class="text-center">
										<div class="dropdown">
											<a href="#" class="btn btn-outline-light btn-icon btn-sm text-body border-transparent rounded-pill"
											...
											<div class="dropdown-menu dropdown-menu-right">
												@if ($izins['status_penyesuaian'] == '902')
													<a href="{{ route('admin.subkoordinator.evaluasipenyesuaian', $izins['id_izin']) }}"
														...
														Komitmen</a>
												@else
													<a href="{{ route('admin.subkoordinator.evaluasi', $izins['id_izin']) }}" class="dropdown-item"><i
