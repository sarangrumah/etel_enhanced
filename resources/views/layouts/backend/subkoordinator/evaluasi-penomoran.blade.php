...
@section('content')
	...
	<form method="post" id="formEvaluasi" enctype="multipart/form-data"
		...
		<div class="form-group">
										...
										<div class="form-group">
											<div class="col-lg-12">
												<div class="row">
													...
													<div class="col-lg">
														<input type="text" class="form-control" value="{!! isset($penomoran['jenis_layanan_html_nomor']) ? $penomoran['jenis_layanan_html_nomor'] : '' !!}" disabled>
													</div>
												</div>
											</div>
										</div>
							...
							<div class="form-group row">
								...
								<div class="col-lg-4">
									<select name="status_sk" id="status_sk" data-placeholder="Silakan Pilih" class="form-control" required>
										<option value="null" selected disabled>-- Pilih Hasil Evaluasi --</option>
			...
			<div class="text-right">
				...
				<button type="button" id="btnSubmitModal" onclick="return validateForm();" class="btn btn-indigo">Kirim Evaluasi
