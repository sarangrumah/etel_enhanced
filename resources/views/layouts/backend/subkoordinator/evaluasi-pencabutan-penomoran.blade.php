...
@section('content')
    ...
    <form method="post" id="formEvaluasi"
        action="{{ route('admin.subkoordinator.evaluasi-pencabutanpenomoranPost', [$penomoran->id_izin]) }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-12 form-group row">
                                <div class="col-lg-12">
                                    ...
                                    <textarea rows="3" cols="3" class="form-control" id="catatan_hasil_evaluasi" {{-- placeholder="Catatan Hasil Evaluasi" name="catatan_hasil_evaluasi">{{ $penomoran->catatan_hasil_evaluasi }}</textarea> --}}
