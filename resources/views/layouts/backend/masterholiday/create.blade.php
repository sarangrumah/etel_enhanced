	...
	<div>
		...
		<div class="card">
			...
			<div class="card-header d-flex py-0">
				<h6 class="card-title font-weight-semibold py-3">Form Daftar Hari Libur</h6>
			...
			<div class="card-body">
				<form id="formhistoryperizinan" method="post" action="{{ route('admin.masterholiday.store') }}">
					@csrf
					<div class="row">
						<div class="col-lg-12">
							<div class="form-group row">
								...
								<div class="col-lg-8">
									<input type="date" class="form-control" name="off_day"></input>
								</div>
								<div class="col-lg-2">
							...
							<div class="form-group row">
								...
								<div class="col-lg-10">
									<select name="id_kategori" data-placeholder="Silakan Pilih" class="form-control form-control-select2" required>
										...
										<option value="Uji Laik Operasi">Uji Laik Operasi </option>
