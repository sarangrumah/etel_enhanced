...
<body>
	...
	<div>
		<p style="text-align: justify !important;">Telah memenuhi syarat kelaikan operasi untuk penyelenggaraan telekomunikasi
			...
			<tr style="vertical-align:top;">
				...
				<td>
					...
					{{ isset($data['tanggal_evaluasi_pelaksanaan_ulo'])
					    ...
					    : '' }}
					telah
					selesai dilakukan Evaluasi Uji Laik Operasi dengan metode Uji Petik / Penilaian Mandiri pada {{ $jenis_layanan }}
					milik
					...
					<table class='table-inner' style="border-spacing:0px !important;">
						...
						<tr style="vertical-align:top;">
							...
							<td style="vertical-align:top">
								<p>Uji Petik / <br />Penilaian Mandiri</p>
							</td>
							<td style="vertical-align:top">
								@if (isset($map_izin))
									<ol>
												...
												@if (isset($mi->form_isian))
													@switch($mi->component_name)
														...
														@case('cakupanwilayahtelsus_skrd')
															<li>Media Transmisi Spektrum Frekuensi Radio untuk Sistem Komunikasi Radio untuk
																Data</li>
														@break

														@case('cakupanwilayahtelsus_skrk')
															<li>Media Transmisi Spektrum Frekuensi Radio untuk Sistem Komunikasi Radio
																Konvensional</li>
														@break

														@case('cakupanwilayahtelsus_skrt')
															<li>Media Transmisi Spektrum Frekuensi Radio untuk Sistem Komunikasi Radio Trunking
															</li>
														@break

														@case('cakupanwilayahtelsus_sks')
															<li>Media Transmisi Spektrum Frekuensi Radio untuk Sistem Komunikasi Satelit</li>
														@break
													@endswitch
												@endif
											@endif
