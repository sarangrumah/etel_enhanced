		...
		@if ($d->group_permohonan == 'Penetapan')
			...
			<div style="text-align:center !important;">
				...
				<h2 class="judul">PENETAPAN {!! isset($data['kode_akses']['jenis_kode_akses']['full_name_html'])
					...
					@endif
					{{-- {{ (isset($datanib['nama_perseroan']) ? strtoupper($datanib['nama_perseroan']) : isset($datanib['nama_institusi'])) ? strtoupper($datanib['nama_institusi']) : '' }} --}}
					<br />
			...
			<table style="text-align: justify !important;width:100%;padding-right:10px;">
				...
				<tr style="vertical-align:top !important;">
					...
					<td>
						{{ isset($datanib['alamat_perseroan']) ? strtoupper($datanib['alamat_perseroan']) : strtoupper($datanib['alamat_institusi']) . ', ' . $datanib['detail_loc'] . ' ' . $datanib['kodepos'] }}
					</td>
				</tr>
				<tr style="vertical-align:top !important;">
					<td style="padding-left:10px;" colspan="3">
