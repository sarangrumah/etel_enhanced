...
<body>
	...
	<div style="text-align:center !important;"><img style="width:120px;" src="{{ public_path('global_assets/images/logo_kominfo.png') }}"></div>
	<div style="text-align:center !important;">
		<br />
		<font size="3">PENETAPAN KEWAJIBAN PEMBANGUNAN<br />
			PENYELENGGARA JARINGAN TETAP TERTUTUP</font><br />

		<font size="3">PT {{$nama_perseroan}}</font><br /><br /><br />
	</div>
	<div>
		<ol>
			<li>PT {{$nama_perseroan}} telah menyampaikan surat pernyataan pemenuhan kewajiban pembangunan dan/atau penyediaan Penyelenggaraan Jaringan tertanggal {{date('d F Y')}}</li>
			<li>
				Menetapkan kewajiban pembangunan dan/atau penyediaan selama 5 (lima) tahun bagi PT {{$nama_perseroan}} sebagai penyelenggara Jaringan Tetap Tertutup berdasarkan… (Keputusan Menteri Komunikasi dan Informatika No… Tahun…. tentang Izin Penyelenggaraaan Jaringan Tetap Tertutup PT {{$nama_perseroan}}./Perizinan Berusaha Berbasis Risiko Izin:…..) Paling sedikit sebagai berikut
				<br /><br />
				...
				<div>
					...
					<ol type="a">
						...
						<li>Periode tahun kedua dan seterusnya terhitung sesuai dengan tahun buku (1 Januari sampai dengan 31 Desember).</li>
					</ol>
				</div>
			</li>
			<br /><br /><br /><br />
			<li>
				PT {{$nama_perseroan}}. wajib memenuhi komitmen kerja pelayanan jaringan telekomunikasi Penyelenggaraan Jaringan Tetap Tertutup sebagai berikut:
				<br /><br />
			...
			<li>
				Pelaksanaan evaluasi penyelenggaraan jaringan tetap tertutup tahunan dan 5 (lima) tahuanan atas kewajiban pembangunan dan/atau penyediaan mengacu pada penetapan ini.
			</li>
		</ol>
