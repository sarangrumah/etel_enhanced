	...
	@foreach ($penomoran_kodeakses as $item => $d)
		@if ($d->group_permohonan == 'Penetapan')
			...
			<div style="text-align:center !important;">
				...
				<h2 class="judul">PENETAPAN {!! isset($data['kode_akses']['jenis_kode_akses']['full_name_html'])
				    ...
				    : '' !!}
					<br />
					@if (isset($datanib['nama_perseroan']))
						{{ strtoupper($datanib['nama_perseroan']) }}
					@else
						{{ strtoupper($datanib['nama_institusi']) }}
					@endif
			...
			<div>
				<table style="text-align: justify !important;width:100%;padding-top:20px;padding-right:10px;padding-bottom:20px;">
					...
					<tr style="vertical-align:top !important;">
						...
						@if (substr($data['id_permohonan'], 0, 3) == 'NEV')
							<td width="91%">
								{{ isset($datanib['dasar_penetapanulang']) ? $datanib['dasar_penetapanulang'] : '' }}.
							</td>
						@else
							<td width="91%">
			...
			<table style="text-align: justify !important;width:100%;padding-right:10px;">
				...
				<tr style="vertical-align:top !important;">
					...
					<td style="width:2%;">:</td>
					<td>
						{{ isset($datanib['alamat_perseroan']) ? $datanib['alamat_perseroan'] : strtoupper($datanib['alamat_institusi']) . ', ' . $datanib['detail_loc'] . ' ' . $datanib['kodepos'] }}
					</td>
				</tr>
				<tr style="vertical-align:top !important;">
					<td style="padding-left:10px;" colspan="3">
				...
				<tr>
					...
					<td style="text-align:center;">
						...
						<img style="width:70px;" src="data:image/png;base64, {!! base64_encode(
						    QrCode::format('svg')->size(100)->generate('https://e-telekomunikasi.kominfo.go.id/validasi-sk/' . $data['id_permohonan']),
						) !!} ">
		...
		@elseif ($d->group_permohonan == 'Perubahan Penetapan')
			...
			<div style="text-align:center !important;">
				...
				<h2 class="judul">PENETAPAN {!! isset($data['kode_akses']['jenis_kode_akses']['full_name_html'])
					...
					<br />Nomor : {{ isset($d->no_sk) ? $d->no_sk : '' }}
				</h2>
			</div>
			<div>
				<table style="text-align: justify !important;width:100%;padding-top:20px;padding-right:10px;padding-bottom:20px;">
		...
		@else
			...
			<table style="text-align: justify !important;width:100%;padding-right:10px;">
				...
				{{-- <tr style="vertical-align:top !important;">
                        <td style="padding-left:10px;" colspan="3">
                            <p>Menetapkan {!! isset($data['kode_akses']['jenis_kode_akses']['full_name_html'])
                                ? $data['kode_akses']['jenis_kode_akses']['full_name_html']
                                : '' !!}
                                {{ isset($d->kode_akses) ? $d->kode_akses : '' }}
                                untuk Penyelenggaraan {!! isset($data['jenis_layanan_html_nomor']) ? $data['jenis_layanan_html_nomor'] : '' !!}
                    ...
                    <tr style="vertical-align:top !important;">
                        <td style="padding-left:10px;" colspan="3">
                            <p>Dalam menggunakan {!! isset($data['kode_akses']['jenis_kode_akses']['full_name_html'])
                                ? $data['kode_akses']['jenis_kode_akses']['full_name_html']
                                : '' !!} tersebut di atas,
                                {{ isset($data['nama_perseroan']) ? strtoupper($data['nama_perseroan']) : '' }} wajib
                                melaporkan
                                penggunaan
                                penomoran telekomunikasi yang telah ditetapkan setiap 1 (satu) tahun sejak ditetapkan.
                            </p>
                            <p>
                                Direktorat Jenderal Penyelenggaraan Pos dan Informatika akan melakukan monitoring dan
                                evaluasi
                                terhadap penggunaan {!! isset($data['kode_akses']['jenis_kode_akses']['full_name_html'])
                                    ? $data['kode_akses']['jenis_kode_akses']['full_name_html']
                                    : '' !!} tersebut.
