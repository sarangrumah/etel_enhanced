...
<body>
    ...
    <div style="text-align:center !important;">
        ...
        <font size="4">Nomor : {{ isset($data['nomor_sklo_fixed']) ? $data['nomor_sklo_fixed'] : '' }} </font><br /><br /><br />
    </div>
    <?php
        ...
        <table>
            ...
            <tr>
                ...
                <td style="text-align:center;">
                    ...
                    <br /> u.b<br /> <br />
                    <img style="width:70px;" src="data:image/png;base64, {!! base64_encode(QrCode::format('svg')->size(100)->generate('https://e-telekomunikasi.kominfo.go.id/validasi-sk/'.$data['id_izin'])) !!} ">
            ...
            <tr style="vertical-align:top;">
                ...
                <td style="text-align: justify !important;">
                    ...
                    {{ isset($data['tanggal_evaluasi_pelaksanaan_ulo'])
                        ...
                        : '' }}
                    telah
                    selesai dilakukan Evaluasi Uji Laik Operasi dengan metode @if ($data['tipe_ulo'] == 1)
                        Uji Petik
                    @else
                        Penilaian Mandiri
                    @endif pada {!! $jenis_layanan !!} milik
                    {{ isset($data['nama_perseroan']) ? $data['nama_perseroan'] : '' }} dengan hasil sebagai
                    berikut:
                    <br />
                    <br />
                    <table class='table-inner' style="border-spacing:0px !important;">
                        ...
                        <tr style="vertical-align:top;">
                            ...
                            <td style="vertical-align:top">{!! isset($data['alamat_pusat_layanan_pelangan']) ? $data['alamat_pusat_layanan_pelangan'] : '' !!}</td>
