					...
					<div class="col">
						<fieldset>
							<div class="form-group row">
								...
								<div class="col-lg-8">
									<select name="perizinan" class="form-control" data-placement="bottom"
							...
							<div class="form-group row">
								...
								<div class="col-lg-8">
									<select class="form-control" name="jeniskbli" id="jeniskbli" data-toggle="tooltip" data-placement="bottom"
										title="Pilih Perizinan KBLI" required>
										<option value="">Silakan Pilih..</option>
									</select>
								</div>
							</div>
							<div class="form-group row" id="PilihNomor">
								...
								<div class="col-lg-8">
									<select class="form-control" name="jenislayanan" data-toggle="tooltip" data-placement="bottom"
									...
									<tbody id="bloknomor-lists">
										@for ($i = 0; $i < 1; $i++)
											<tr class="bloknomor-item">
												<td style="width: 60%;">
													<select name="bloknomor[{{ $i }}][kode_wilayah]" class="form-control pilih-kodewilayah">
												...
												<td style="width: 30%;">
													<input type="text" class="form-control pilih-bloknomor" name="bloknomor[{{ $i }}][prefix]"
														placeholder="Prefix Awal" />
												</td>
												<td style="width: 10%;">
													<div class="col-lg-2">
														<button type="button" class="btn btn-success add-bloknomor" id="add-bloknomor"><i
									...
									<div class="col-6">
										<div class="col-lg-12 row">
											...
											<div class="col-lg-12 form-group">
												<input type="file" name="SKPenetapanPenomoran" id="SKPenetapanPenomoran" class="form-control h-auto"
													accept="application/pdf" data-toggle="tooltip" data-placement="bottom" title="Unggah SK Penetapan"
													required>
