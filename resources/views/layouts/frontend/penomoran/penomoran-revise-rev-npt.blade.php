				...
				<div class="row">
					<div class="col">
						<fieldset>
							<div class="form-group row">
								<label class="col-lg-4 col-form-label">Alasan Perubahan</label>
								<div class="col-lg-8">
									<select name="reasonrevise" class="form-control" data-toggle="tooltip" data-placement="bottom"
					...
					<div class="col">
                            ...
                            <div class="col-lg-8">
                                <select class="form-control" name="jeniskodeakses" id="jeniskodeakses">
                                    ...
                                    @foreach ($kblinomor_pt as $kblinomor_pt)
                                        <option value="{{ $kblinomor_pt->short_name }}">{!! $kblinomor_pt->full_name_html !!}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
						...
						<div class="form-group row">
							...
							<div class="col-lg-8">
								<input type="hidden" name="NoSKPenetapanPenomoran_hide" id="NoSKPenetapanPenomoran_hide">
						...
						<div class="form-group row">
							...
							<div class="col-lg-8">
								<input type="hidden" name="DateSKPenetapanPenomoran_hide" id="DateSKPenetapanPenomoran_hide">
							...
							@if ($penyesuaian)
								<div class="row">
									<div class="col-6">
										...
										{{-- <div class="form-group row">
                                            <div class="col-lg-12">
                                                <label class="col-form-label">SK Perizinan Berusaha<span
                                                        class="text-danger">*</span></label>
                                            </div>
                                            <div class="col-lg-12">
                                                <input type="file" name="SKPerizinanBerusaha" id="SKPerizinanBerusaha"
                                                    class="form-control h-auto required" accept="application/pdf"
                                                    required>
                                            </div>
                                        </div> --}}
									</div>
			...
			$('select[name="jeniskodeakses"]').on('change', function() {
				...
				if (jenis_kodeakses) {
					if (id_jeniskodeakses_var.value == 'Blok Nomor') {
						...
						$.ajax({
							url: '/api/getkodeakses_nomor_re_npt/' + jenis_kodeakses,
							type: "GET",
							dataType: "json",
							success: function(data) {
								// console.log(data);
