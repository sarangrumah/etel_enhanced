			...
			<div class="card-body">
				<div class="row">
					<div class="col">
						<fieldset>
							<div class="form-group row">
								...
								<div class="col-lg-8">
									<select name="perizinan" class="form-control" data-toggle="tooltip" data-placement="bottom"
					...
					<div class="col">
						...
						<div class="form-group row" id="PilihNomor">
							<label class="col-lg-4 col-form-label d-none" id="lbl_kdakses">Daftar Blok Nomor</label>
							<div class="col-lg-8 d-none" id="availno_opt">
								<select class="form-control form-control-select2" id="availno" name="availno" required>
							...
							<div class="col-lg-8 d-none" id="PilihKodeWilayah">
									...
									<tbody id="bloknomor-lists">
										@for ($i = 0; $i < 1; $i++)
											<tr class="bloknomor-item">
												<td style="width: 60%;">
													<select name="bloknomor[{{ $i }}][kode_wilayah]" class="form-control pilih-kodewilayah" required>
												...
												<td style="width: 30%;">
													<input type="text" class="form-control pilih-bloknomor" name="bloknomor[{{ $i }}][prefix]"
														placeholder="Prefix Awal" required />
												</td>
												<td style="width: 10%;">
													<div class="col-lg-2">
								...
								<div>
									<label class="col-lg col-form-label">*) Wilayah Penomoran
										Berdasarkan Peraturan Menteri Komunikasi dan Informatika Nomor 14 Tahun 2018 tentang
										Rencana
				...
				<div class="row">
					@if ($penambahan)
						<div class="col-lg-6">
							<fieldset>
								<div class="form-group row">
									<div class="col-lg-12">
										<label class="col-lg-12 col-form-label">Dokumen Perizinan Berusaha<span class="text-danger">*</span></label>
									</div>
									<div class="col-lg-12">
								...
								<div class="form-group row">
									<div class="col-lg-12">
										<input type="file" name="SKPenetapanPenomoran" id="SKPenetapanPenomoran"
											class="form-control h-auto required" accept="application/pdf" data-toggle="tooltip"
											data-placement="bottom" title="Unggah Dokumen SK Penetapan Penomoran" required>
									</div>
								</div>
							</div>
							<div class="col">
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="form-group row">
								<div class="col-lg-12">
									<label class="col-lg-12 col-form-label">Dengan ini saya menyatakan bahwa seluruh data
										yang
									...
									<label class="col-lg-12 col-form-label custom-control custom-checkbox custom-control-inline">
...
@section('custom-js')
	...
	<script>
		...
		submitButton.addEventListener('click', function(event) {
			...
			if ($("#frm")[0].checkValidity()) {
				...
				$('#frm :input[required="required"]').each(function() {
					if (!this.validity.valid || $(this).val().trim() === '') {
						$(this).focus();
						$(this).tooltip();
						$(this).tooltip('show');
						// alert(
		...
		// function isKodeAksesSelected() {
		//     var kodeaksesselected = document.querySelector('.custom-control-input');
		//     return checkbox.checked;
		// }
			...
			if (penambahan == 1) {
				if (izinlayanan) {
					$.ajax({
						...
						url: '/api/getjeniskodeakses_nomor_excPLM/' + izinlayanan,
						type: "GET",
						dataType: "json",
						success: function(data) {
							console.log(data);
		...
		$('select[name="jeniskodeakses"]').on('change', function() {
			...
			if (jenis_kodeakses) {
				if (id_jeniskodeakses_var.value == 'Blok Nomor') {
					...
					$("#PilihKodeWilayah").removeClass("d-none");
					$("#NoPrefixAwal").removeClass("d-none");
					$('select[name="availno"]').removeAttr('required');
					...
					$("#PilihKodeWilayah").addClass("d-none");
					$("#NoPrefixAwal").addClass("d-none");
					$('select[name="bloknomor[0][kode_wilayah]"]').removeAttr('required');
					$('input[name="bloknomor[0][prefix]"]').removeAttr('required');
					// $('select[name="bloknomor[0][kode_wilayah]"]').empty();

					$('.pilih-bloknomor').removeAttr('required');
					...
					$.ajax({
						url: '/api/getkodeakses_nomor/' + jenis_kodeakses,
						type: "GET",
						dataType: "json",
						success: function(data) {
							// console.log(data);
