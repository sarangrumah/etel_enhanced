...
@section('content')
	...
	<div class="card">
		<div class="card-header">
			<div class="row">
				<div class="col-lg-8">
					<h6 class="card-title font-weight-semibold py-3">Daftar Permohonan</h6>
				</div>
				<div class="d-inline-flex align-items-center ml-auto">
					<div class="dropdown ml-2">
						@if ($status_evaluasi == '0')
							...
							@endif
						@elseif ($status_suspend == '1')
							@if (Auth::user()->jenis_pu == 'NPT')
								<td><button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#" data-popup="tooltip"
										title="Akun Anda Ditangguhkan. Penangguhan Akun dikarenakan Akun Anda tidak aktif dalam 6 Bulan"
										data-placement="left">Permohonan
										Penomoran <i class="icon-file-plus mr-2"></i></button></td>
							@elseif (Auth::user()->jenis_pu == 'PTB')
								<td><button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#" data-popup="tooltip"
										title="Akun Anda Ditangguhkan. Penangguhan Akun dikarenakan Akun Anda tidak aktif dalam 6 Bulan"
										data-placement="left">Tambah
										Permohonan Izin <i class="icon-file-plus mr-2"></i></button>
								</td>
								<td><button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#" data-popup="tooltip"
										title="Akun Anda Ditangguhkan. Penangguhan Akun dikarenakan Akun Anda tidak aktif dalam 6 Bulan"
						...
						@else
							@if (Auth::user()->jenis_pu == 'NPT' && $status_evaluasi == '1')
								...
								<div class="dropdown-menu dropdown-menu-right">
									<a href="{{ url('/penomoran/barunpt') }}" class="dropdown-item"><i class="icon-database-add"></i> Nomor
										Baru</a>
			...
			<table class="table text-nowrap datatable-button-init-basic" id="table">
				<thead>
					<tr>
						...
						<th class="text-center sorting sorting_desc">Tanggal Permohonan</th>
				...
				<tbody id="tBoodyDataAll">
					@foreach ($izin as $item)
						<tr>
							...
							@endif
							<td class="text-center" hidden><span class="badge badge-success-100 text-success">{{ $item->status_fo }}</span>
							</td>
