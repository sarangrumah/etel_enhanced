                            ...
                            <tr class="rolloutplan-item">
                                <td style="width: 10%;">
                                    ...
                                    <input type="number" min="1" value="{{ $d['periode'] }}"
                                        ...
                                        name="rolloutplan[{{ $loop->iteration }}][periode]" required />
                                </td>
                                <td style="width: 70%;">
                                    <input type="text" value="{{ $d['kapasitas_transponder_satelit'] }}"
                                        {{ $is_editable ? '' : 'readonly' }} class="form-control"
                                        name="rolloutplan[{{ $loop->iteration }}][kapasitas_transponder_satelit]" required />
                                
                                </td>
                                @if ($needcorrection == 1)
                                    <td style="width: 10%;">
                                            <div>
                                                <select name="rolloutplan[{{ $loop->iteration }}][isdeleted]"
                                                    id="" class="form-control isdeleted_cakupanwilayahtelsus_mtk"
                                                    required>
                                                    <option
                                                        name="rolloutplan[{{ $loop->iteration }}][isdeleted]"
