                    ...
                    @if (isset($d['isdeleted_rencanausaha']))
                        @if ($d['isdeleted_rencanausaha'] == '1')
                            <tr class="rencanausaha-item">
                                ...
                                <td>
                                    <input {{ $is_editable ? '' : 'readonly' }} value="{{ $d['pks'] }}"
                                        type="text" class="form-control pks-rencanausaha"
                                        name="rencanausaha[{{ $key }}][pks]" />
                                </td>
                                <td style="width: 10%;">
                                    <div>
                        ...
                        <tr class="rencanausaha-item">
                            ...
                            <td>
                                <input {{ $is_editable ? '' : 'readonly' }} value="{{ $d['pks'] }}" type="text"
                                    class="form-control pks-rencanausaha"
                                    name="rencanausaha[{{ $key }}][pks]" />
                            </td>
                            <td style="width: 10%;">
                                <div>
            ...
            @else
                @for ($i = 0; $i < 5; $i++)
                    <tr class="rencanausaha-item">
                        ...
                        <td>
                            <input type="text" class="form-control pks-rencanausaha"
                                name="rencanausaha[{{ $i }}][pks]" />
                        </td>
                        <td></td>
                    </tr>
                @endfor
