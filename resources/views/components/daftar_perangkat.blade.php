		...
		@foreach ($datajson as $key => $d)
			@if (isset($d['isdeleted_perangkat']))
				@if ($d['isdeleted_perangkat'] == '1')
					<div class="device-form-row mb-3" data-index="{{ $key }}">
						<div class="px-3 py-3 daftar-perangkat-item" style="border: 1px solid #ddd">
							@if ($is_editable)
								<div class="col-md-2">
								...
								<div>
									<select name="daftar_perangkat[{{ $key }}][isdeleted_perangkat]" id=""
										class="form-control isdeleted_perangkat" required>
										<option name="daftar_perangkat[{{ $key }}][isdeleted_perangkat]" value="1" selected>Tidak
										</option>
										<option name="daftar_perangkat[{{ $key }}][isdeleted_perangkat]" value="2">Hapus</option>
							...
							<div class="row mt-3">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input class="form-control jenis_perangkat" name="daftar_perangkat[{{ $key }}][jenis_perangkat]"
											value="{{ $d['jenis_perangkat'] }}" required {{ $is_editable ? '' : 'disabled' }} />
									</div>
									<div class="form-group">
										<label for="">Merk Perangkat</label>
										<input class="form-control merk_perangkat" name="daftar_perangkat[{{ $key }}][merk_perangkat]"
											value="{{ $d['merk_perangkat'] }}" required {{ $is_editable ? '' : 'disabled' }} />
									</div>
									<div class="form-group">
										<label for="">Nomor <i>Serial Number</i> Perangkat</label>
										<input class="form-control sn_perangkat" name="daftar_perangkat[{{ $key }}][sn_perangkat]"
									...
									<div class="form-group">
										...
										<div class="input-group">
											...
											<?php
                                                ...
                                                ?>
											<input {{ $is_editable ? '' : 'disabled' }} name="daftar_perangkat[{{ $key }}][foto_perangkat]"
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input class="form-control tipe_perangkat" name="daftar_perangkat[{{ $key }}][tipe_perangkat]"
											value="{{ $d['tipe_perangkat'] }}" required {{ $is_editable ? '' : 'disabled' }} />
									</div>
									<div class="form-group">
										<label for="">Negara Asal Pembuat Perangkat</label>
										<input class="form-control buatan_perangkat" name="daftar_perangkat[{{ $key }}][buatan_perangkat]"
									...
									<div class="form-group">
										...
										<div class="input-group">
											...
											<?php
                                                    ...
                                                    ?>
											<input {{ $is_editable ? '' : 'disabled' }} name="daftar_perangkat[{{ $key }}][foto_sn_perangkat]"
	...
	@else
		...
		<div class="device-form-row mb-3" data-index="{{ $key }}">
			<div class="px-3 py-3 daftar-perangkat-item" style="border: 1px solid #ddd">
				<div>
					<div>
						<small for="" class="text-danger mr-2">*Catatan : Untuk beberapa perangkat, memiliki kententuan yang
							harus didaftarkan pada Layanan Sertifikasi <a href='https://sertifikasi.postel.go.id'> sertifikasi.postel.go.id
							</a>.</small>
					</div>
					<div class="">
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group hidden">
							...
							<input class="form-control sertifikat_perangkat" name="daftar_perangkat[0][sertifikat_perangkat]" />
						</div>
					</div>
					<div class="col-6">
						<div class="form-group hidden">
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							<label for="">Jenis Perangkat</label>
							<input class="form-control jenis_perangkat" name="daftar_perangkat[0][jenis_perangkat]" required />
						</div>
						<div class="form-group">
							<label for="">Merk Perangkat</label>
							<input class="form-control merk_perangkat" name="daftar_perangkat[0][merk_perangkat]" required />
						</div>
						<div class="form-group">
							<label for="">Nomor <i>Serial Number</i> Perangkat</label>
							<input class="form-control sn_perangkat" name="daftar_perangkat[0][sn_perangkat]" required />
						</div>
						<div class="form-group">
					...
					<div class="col-md-6">
						<div class="form-group">
							<label for="">Tipe Perangkat</label>
							<input class="form-control tipe_perangkat" name="daftar_perangkat[0][tipe_perangkat]" required />
						</div>
						<div class="form-group">
							<label for="">Negara Asal Pembuat Perangkat</label>
							<input class="form-control buatan_perangkat" name="daftar_perangkat[0][buatan_perangkat]" required />
						</div>
						{{-- <div class="form-group hidden">
                            <label for="">Nomor Sertifikat Perangkat</label>
                            <input class="form-control sertifikat_perangkat"
...
@if ($datajson == 'kosong' || $is_editable)
	<div class="mt-2 text-right">
		<button type="button" class="btn-secondary btn-sm" onclick="addDeviceRow()">Tambah Data
...
<script>
	...
	function addDeviceRow() {
		const container = document.getElementById('daftar_perangkat_lists');
		...
		newRow.innerHTML = `
                <div class="px-3 py-3 daftar-perangkat-item" style="border: 1px solid #ddd;position: relative;">
                        ...
                        <div>
                            <div class="">
                                <label for="switchPerangkat"> ` + deviceIndex + ` Apakah anda memiliki sertifikat perangkat?</label>
                                <input type="checkbox" class="switchPerangkat" id="switchPerangkat">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group hidden">
                                    <label for="">No Sertifikat Perangkat</label>
                                    <input class="form-control sertifikat_perangkat"
                                        name="daftar_perangkat[` + deviceIndex + `][sertifikat_perangkat]" />
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group hidden">
                                    <label for="">Lampiran Sertifikasi Perangkat</label>
                                    <input type="file" accept="application/pdf" class="form-control sertifikasi_alat h-auto"
                                        name="daftar_perangkat[` + deviceIndex + `][sertifikasi_alat]" />
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="">Lokasi Perangkat</label>
                                    <textarea class="form-control lokasi_perangkat" name="daftar_perangkat[` +
			deviceIndex + `][lokasi_perangkat]" required></textarea>
                                </div>
                            </div>
                        </div>
                        <hr class="w-100"/>
                        <div class="row">                            
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="">Jenis Perangkat</label>
                                    <input class="form-control jenis_perangkat" name="daftar_perangkat[` +
			deviceIndex + `][jenis_perangkat]" required />
                                </div>
                                <div class="form-group">
                                    <label for="">Merk Perangkat</label>
                                    <input class="form-control merk_perangkat" name="daftar_perangkat[` + deviceIndex + `][merk_perangkat]" required />
                                </div>
                                <div class="form-group">
                                    <label for="">Nomor <i>Serial Number</i> Perangkat</label>
                                    <input class="form-control sn_perangkat" name="daftar_perangkat[` + deviceIndex +
			`][sn_perangkat]" required />
                                </div>
                                <div class="form-group">
                                    <label for="">Foto Perangkat</label>
                                    <input type="file" accept="application/pdf" class="form-control foto_perangkat h-auto" name="daftar_perangkat[` +
			deviceIndex + `][foto_perangkat]" required />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="">Tipe Perangkat</label>
                                    <input class="form-control tipe_perangkat" name="daftar_perangkat[` + deviceIndex + `][tipe_perangkat]" required />
                                </div>
                                <div class="form-group">
                                    <label for="">Negara Asal Pembuat Perangkat</label>
                                    <input class="form-control buatan_perangkat" name="daftar_perangkat[` +
			deviceIndex +
			`][buatan_perangkat]" required />
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <label for="">Foto <i>Serial Number</i> Perangkat</label>
                                        <input type="file" accept="application/pdf" class="form-control foto_sn_perangkat h-auto" name="daftar_perangkat[` +
			deviceIndex + `][foto_sn_perangkat]" required />
                                    </div>
                                </div>
                            </div>
                        </div>
