...
Route::group(['prefix' => 'admin'], static function () {
    Route::middleware(['admin'])->group(function () {
        ...
        Route::post('/ip/getKabupaten', [InstansiPemerintah::class, 'getKabupaten'])->name('getKabupaten');
        Route::post('/ip/getKecamatan', [InstansiPemerintah::class, 'getKecamatan'])->name('getKecamatan');
        Route::post('/ip/getKelurahan', [InstansiPemerintah::class, 'getKelurahan'])->name('getKelurahan');
        ...
        //BIMTEK
        Route::get('/evaluasi-bimtek', [Admin\KoordinatorController::class,
        'evaluasiBimtek'])->name('admin.verifikatornib.evaluasiBimtek')->middleware('jabatancheck');
        Route::post('/evaluasi-bimtekpost', [Admin\KoordinatorController::class,
        'evaluasiBimtekPost'])->name('admin.verifikatornib.evaluasiBimtekPost')->middleware('jabatancheck');

        //ULO Schedule
        Route::get('/ulo-calendar', [Admin\ScheduleController::class,
        'show'])->name('admin.evaluator.uloschedule');
        Route::get('/ulo-calendar-all', [Admin\ScheduleController::class,
        'getschedule'])->name('admin.evaluator.getschedule');
        Route::get('/ulo-calendarmgt', [Admin\ScheduleController::class,
        'manageschedule'])->name('admin.evaluator.manageschedule');
        Route::post('/schedule/store', [Admin\ScheduleController::class,
        'store'])->name('admin.schedule.store');
        Route::post('/schedule/update/{id}', [Admin\ScheduleController::class,
        'update'])->name('admin.schedule.update')->middleware('jabatancheck');
        Route::post('/schedule/destroy/{id}', [Admin\ScheduleController::class,
        'destroy'])->name('admin.schedule.destroy')->middleware('jabatancheck');
        ...
        Route::get('/verifikatornib/reaktifasiakun-post/{id}', [Admin\KoordinatorController::class,
        'reaktifasiakunPost'])->name('admin.verifikatornib.reaktifasiakunpost')->middleware('jabatancheck');
        ...
        Route::get('/koordinator/redisposisi', [Admin\KoordinatorController::class, 'redisposisi_dashboard'])->name('admin.koordinator.redisposisi_dashboard')->middleware('jabatancheck');
        Route::get('/koordinator/redisposisi/{id}', [Admin\KoordinatorController::class, 'redisposisi'])->name('admin.koordinator.redisposisi')->middleware('jabatancheck');
        ...
        Route::get('/koordinator/redisposisi-ulo/{id}/{urut}', [Admin\KoordinatorController::class, 'redisposisiUlo'])->name('admin.koordinator.redisposisi-ulo')->middleware('jabatancheck');
        ...
        Route::get('/evaluator/penetapan-ulangpenomoran/{id}', [Admin\EvaluatorController::class,
        'ulangPenomoran'])->name('admin.evaluator.ulangnomor')->middleware('jabatancheck');
        ...
        Route::post('/evaluator/evaluasi-penetapanulangpenomoranPost/{id}', [Admin\EvaluatorController::class,
        ...
        Route::get('/sk/draft-penomoran-ulang/{id}', [Admin\SkController::class,
        'draftpenomoranpenetapanulang'])->name('admin.sk.draftpenomoranpenetapanulang')->middleware('jabatancheck');
        ...
        Route::get('/sk/cetak-izin-prinsip-telsus/{id}', [Admin\SkController::class, 'cetakIzinPrinsip'])->name('admin.sk.cetakIzinPrinsip')->middleware('jabatancheck');
        Route::get('/sk/cetak-izin-penyelenggaraan-telsus/{id}', [Admin\SkController::class, 'cetakIzinPenyelenggaraan'])->name('admin.sk.cetakIzinPenyelenggaraan')->middleware('jabatancheck');
        ...
        Route::get('/survei/result_detail/{period_month}/{period_year}', [Admin\SurveiController::class, 'result_survei_detail'])->name('admin.survei.result_survei_detail')->middleware('jabatancheck');
        ...
        Route::get('/survei/result_new/{id}', [Admin\SurveiController::class, 'result_new'])->name('admin.survei.result_new')->middleware('jabatancheck');
        ...
        Route::get('/download-tetap_penomoran',  [Admin\ExcelController::class, 'tetap_penomoran'])->name('download.tetap_penomoran');

        Route::get('/download-IKMKIN/{period_month}/{period_year}/{type}',  [Admin\ExcelController::class, 'all_summary'])->name('download.summary_IKM');
        Route::get('/download-pertanyaan',  [Admin\ExcelController::class, 'all_quest_active'])->name('download.quest_active');



        Route::get('/testemail/koordinator/{id}',  [Admin\testEmailController::class, 'testemail_ketuatim_disposisi_ip']);
        Route::get('/testemail/pelaku/{id}',  [Admin\testEmailController::class, 'testemail_ketuatim_disposisi_instansi']);
